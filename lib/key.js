...
var CRC_END, CRC_START, Crypto, EXP_LENGTH_START, FLAG_START, FS, HEADER_SIZE, KEY_DATA_START, Key, LENGTH_START;
...
Key = (function() {
  ...
  function Key(exponent, modulus) {
    if (exponent == null) {
      throw new TypeError('Exponent can\'t be null or undefined');
    }
    if (modulus == null) {
      throw new TypeError('Modulus can\'t be null or undefined');
    }
